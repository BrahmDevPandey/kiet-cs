// programs to add two matrices of same order
#include <stdio.h>
#include <conio.h>
...
int main()
{
    ...
    void sumMat(int[][10], int[][10], int[][10], int, int);
    ...
    // adding the matrices into the third matrix
    sumMat(mat1, mat2, mat3, row, col);

    //printing the final sum of matrices
    printf("\nThe sum of the matrices 1 and 2 is: \n");
...
void sumMat(int mat1[][10], int mat2[][10], int mat3[][10], int row, int col)
{
    int i, j;
    for (i = 0; i < row; i++)
        for (j = 0; j < col; j++)
